...
class MvnRepositoryArtifactsProducerTest {
	...
	void mvnrepository_has_some_artifacts_in() {
		...
		Assertions.assertThat(data)
			.containsKey("org.junit.jupiter:junit-jupiter")
			.extractingByKey("org.junit.jupiter:junit-jupiter")
			.hasFieldOrPropertyWithValue("name", "JUnit Jupiter (Aggregator)")
			.hasFieldOrPropertyWithValue("coordinates", "org.junit.jupiter:junit-jupiter")
			;
	}
