...
https://github.com/Riduidel/aadarchi-documentation-system/issues/new?title=Error%20in%20{project-artifact-id}%20v.{project-version}%20chapter%20{chapter}[icon:github[set=fab] enter an issue on GitHub,window=feedback].
endif::[]
