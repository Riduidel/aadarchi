...
https://github.com/Riduidel/agile-architecture-documentation-archetype/issues/new?title=Error%20in%20{project-name}%20v.{project-version}%20chapter%20{chapter}[icon:github[set=fab] enter an issue on GitHub,window=feedback].
endif::[]
