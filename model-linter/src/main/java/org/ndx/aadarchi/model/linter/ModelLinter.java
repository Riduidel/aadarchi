...
public class ModelLinter {
    ...
    public Optional verifyElementDescription(Element element) {
        ...
        if (elementDescription.isEmpty()) {
            setLogger((String.format("your element %s should have a description. " +
                    "A lack of a description prevent user to understand the aim of the element. You should add a description to your element", element.getName())));
        }
        return elementDescription;
    }

    public Optional verifyElementTechnology(Container container) {
    ...
    public Optional verifyElementTechnology(Component component) {
