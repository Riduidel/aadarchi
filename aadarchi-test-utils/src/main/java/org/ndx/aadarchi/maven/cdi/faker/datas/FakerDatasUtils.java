...
public class FakerDatasUtils {
	public static Workspace createTestWorkspace() {

		Workspace workspace = new Workspace(FakerDatasUtils.class.getName(), "a test workspace");
		...
		inputContainer.uses(centerContainer, FakerDatasUtils.CONNECTS_INPUT_TO_CENTER);
		centerContainer.uses(outputContainer, FakerDatasUtils.CONNECTS_CENTER_TO_OUTPUT);
		...
		inputContainer1.uses(centerContainer1, FakerDatasUtils.CONNECTS_INPUT_TO_CENTER);
		inputContainer2.uses(centerContainer1, FakerDatasUtils.CONNECTS_INPUT2_TO_CENTER);
		inputContainer1.uses(centerContainer1, FakerDatasUtils.CONNECTS_INPUT_TO_CENTER);
		centerContainer1.uses(outputContainer1, FakerDatasUtils.CONNECTS_CENTER_TO_OUTPUT);
		centerContainer1.uses(outputContainer1, FakerDatasUtils.CONNECTS_CENTER_TO_OUTPUT);
		centerContainer1.uses(outputContainer2, FakerDatasUtils.CONNECTS_CENTER_TO_OUTPUT2);
		return workspace;
	}
